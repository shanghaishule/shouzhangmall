...
class AES{
    ...
    /* 
     * ���캯��
     * @param: hex ����Ƿ���ʮ�������ʾ��true����ʾ
     * @param: debug �Ƿ��ӡ������Ϣ true����ӡ������Ϣ
     */
	...
	//////////////////////////////////////////////////////////////////
	/*
	 * @function toHexString ���ַ��е�ÿ���ַ�ת����ʮ�������
	 */
    ...
    //////////////////////////////////////////////////////////////////
	/*
	 * @function: encryptString �����ַ�
	 * @param: excodeStr �����ܵ��ַ�
	 * @param: expandedKeys ��չ�����Կ
	 * @return: ���ؼ��ܺ���ַ�
	 */
	...
	//////////////////////////////////////////////////////////////////
	/* 
	 * @function ByteSubShiftRow ������״̬��ÿ���ֽ��ϵ�һ�ַ������ֽ�ת��
	 */
    ...
    //////////////////////////////////////////////////////////////////
    /*
     * @function KeyAddition ��Ȧ��Կ״̬�еĶ�Ӧ�ֽڰ�λ"���"
     */
    ...
    /////////////////////////////////////////////////////////////////
    /* 
     * @function InvShiftRowInvByteSub ������״̬��ÿ���ֽ��ϵ�һ�ַ������ֽڷ�ת������ByteSubShiftRow()����
     */
    ...
    //////////////////////////////////////////////////////////////////
    /*
     * @function MixColumnKeyAddition ����б任
     */
     ...
     * @param��sourcePath �ļ�����Ŀ¼�ľ��·��
     * @param: filename �����ܵ��ļ����
     * @param: expandKeys ��չ�����Կ
     * @param��destPath ��ż��ܺ���ļ����·��
     * @param: encodeFile ���ܺ���ļ����
     * @return: boolean
     */
