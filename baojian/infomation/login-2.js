...
var loginHtml = ''
    ...
    +'    <a href="javascript:;" class="mr10">登录</a>'
    +'    <div class="loginBox">'
    ...
    +'    </div>'
    +'  </div>'
    +'  <a class="zhuce" href="http://passport.39yst.com/register/?appid='+appid+'&x_url='+url+'" target="_blank">注册</a>'
    +'  ';
$('#loginzhuce').html(loginHtml); 
$(document).ready(function(){
    function __comment_login_msg(str){
        $('http://img.39yst.com/statics/ysbk/js/.loginBox .red').eq(0).html(str);
    }
...
$('#denglu').hover(function(){
    $(".loginBox").show();
    //$('.login').css('background','con_pic-1.png'/*tpa=http://img.39yst.com/templates/39yst/img/article/con_pic.png*/)
},function(event){
    return 
});
