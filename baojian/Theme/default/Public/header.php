...
$(function(){
	$("body").Sonline({
		...
		Qqlist:"1402612547|客服01,1402612547|客服02,313362389|客服03,351363496|客服05" //多个QQ用','隔开，QQ和客服名用'|'隔开
	});
})
</script>
</head>
	...
	$('#navModal').on('show.bs.modal', function (e) {
		$('#navModal .input-group-addon').click(function(){
			...
			<?php if(C('URL_MODEL')==0) :
				$url = U('home/perform/nav_del?id=');
			else :
			 	$url = U('home/perform/nav_del').'?id=';
			 endif; ?>
			$('#delnavModal a.btn').attr('href','<?php echo $url; ?>'+id);
		});
	})
</script>
<?php endif; ?>
